...
def save_dataset(dataset, output_path, n):
    ...
    with open('/rep/msalahat/LLMTraining/mysrc/blm/prompts/Task1/system_prompt.txt', 'r') as file:
        system_prompt = file.read()

    # Open the system prompt file and read its content
    with open('/rep/msalahat/LLMTraining/mysrc/blm/prompts/Task1/user_prompt.txt', 'r') as file:
...
def main(args):
    ...
    "csv", 
    data_files={
        "train": "/rep/msalahat/LLMTraining/data/Data2/task1_train.csv", 
        "test":  "/rep/msalahat/LLMTraining/data/Data2/task1_test.csv", 
        "validation": "/rep/msalahat/LLMTraining/data/Data2/task1_validation.csv"
    }
    )
